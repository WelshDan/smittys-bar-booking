"""
Django settings for smittys project.
...
SECRET_KEY = 'django-insecure-rzl9eh20_n&1^z)%e9&jz@17z=yqop^p1q16dz+d6$+g9k=2dv'
...
WSGI_APPLICATION = 'smittys.wsgi.application'
